...
const ListEditDialog = ({ isOpen, list, onSave, onCancel }: ListEditDialogProps) => {
  ...
  const handleSave = () => {
    if (editName.trim()) {
      onSave(list.id, editName.trim(), selectedIcon);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center p-4 z-50 transition-opacity duration-300 ease-in-out">
      <div className="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-xl w-full max-w-sm sm:max-w-md transform transition-all duration-300 ease-in-out scale-100 max-h-[90vh] min-h-[50vh] overflow-y-auto">
        ...
        <div className="mb-4">
          ...
          <div className="grid grid-cols-6 sm:grid-cols-7 gap-1.5 max-h-40 overflow-y-auto justify-items-center">
